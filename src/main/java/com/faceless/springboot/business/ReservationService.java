package com.faceless.springboot.business;
...
public class ReservationService {
    ...
    public List<RoomReservation> getRoomReservationsForDate(Date date) {
        ...
        Iterable<Reservation> reservations = this.reservationRepository.findReservationByResDate(new java.sql.Date(date.getDate()));
